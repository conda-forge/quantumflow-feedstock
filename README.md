...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quantumflow-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14746&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quantumflow-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quantumflow` can be installed with:

```
conda install quantumflow
```

It is possible to list all of the versions of `quantumflow` available on your platform with:
